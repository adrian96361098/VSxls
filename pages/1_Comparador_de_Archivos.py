...
st.set_page_config(
    page_title="Comparador de Archivos · CIEFD",
    page_icon="🔗",
    layout="wide",
)

ahora = mostrar_encabezado(
    titulo_pagina="Comparador y Cruce de Archivos",
    descripcion=(
        "Compara dos archivos (CSV o Excel) a partir de una columna clave en "
        ...
        "de datos consolidada descargable en formato Excel."
    ),
    icono="🔗",
)
